/*
  ...
  1. Functions
    - `check_admin_access` - Function to verify admin access with IP restrictions

  2. Security Policies
    - Role-based access control for all tables
    - Proper separation between public, authenticated, store owners, managers, and admins
    - Data isolation ensuring users can only access authorized data
    - Admin controls with enhanced security checks

  3. Table Coverage
    - All existing tables with appropriate policies
    - Conditional policy creation based on table existence
    - Safe policy dropping to avoid conflicts
*/
...
BEGIN
  IF EXISTS (SELECT FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'stores') THEN
    ...
    IF EXISTS (SELECT FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'store_managers') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'store_hours') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'manager_audit_logs') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'marquee_announcements') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'pop_up_ads') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'product_arrangements') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'fraud_list') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'store_categories') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'store_category_assignments') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'login_attempts') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'admin_ip_whitelist') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'user_2fa') THEN
