...
const CategoriesManagement: React.FC = () => {
  ...
  // Base URL for Supabase Edge Functions (adjust if different in your deployment)
  ...
  useEffect(() => {
    const fetchCategories = async () => {
      try {
        ...
        const storeCats = await authenticatedFetch(`${SUPABASE_FUNCTIONS_URL}/store-category-manager`, { method: 'GET' });
        setStoreCategories(storeCats || []);

        // Fetch product categories
        const productCats = await authenticatedFetch(`${SUPABASE_FUNCTIONS_URL}/product-category-manager`, { method: 'GET' });
  ...
  const handleCreateCategory = async () => {
    ...
    try {
      ...
      const data = await authenticatedFetch(`${SUPABASE_FUNCTIONS_URL}/${endpoint}`, {
        method: 'POST',
        body: JSON.stringify({
  ...
  const handleUpdateCategory = async (id: string, type: 'store' | 'product', updates: Partial<Category>) => {
    try {
      ...
      await authenticatedFetch(`${SUPABASE_FUNCTIONS_URL}/${endpoint}`, {
        method: 'PUT',
